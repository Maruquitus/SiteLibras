...
var módulos = [
    {"título":"Expressões de alunos", "id":"sntDyFlilGE"},
    {"título":"Expressões de professores", "id":"sntDyFlilGE"},
    {"título":"Cumprimentos", "id":"sntDyFlilGE"},
    {"título":"Vocabulário", "id":"sntDyFlilGE"},
    {"título":"Alfabetos e números", "id":"sntDyFlilGE"}
]
...
for (let i = 0; i < módulos.length; i++) {
    ...
    v.on('ended', function() {
      ...
      vistos = mod;
      document.cookie = "modulosprofessoresvistos=" + mod.toString() + ";";
      this.exitFullscreen();
...
function update() {
  var vistos = parseInt(getCookie("modulosprofessoresvistos"));
  if (isNaN(vistos)) {
      vistos = 1;
      document.cookie = "modulosprofessoresvistos=1;";
  }
